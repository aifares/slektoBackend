-- Add media metadata columns to files table for ColorLight media sync
-- This enables enrichment of file records with metadata from ColorLight's media endpoint
